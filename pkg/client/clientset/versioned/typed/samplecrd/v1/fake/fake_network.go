...
var networksResource = schema.GroupVersionResource{Group: "samplecrd.my.crd", Version: "v1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "samplecrd.my.crd", Version: "v1", Kind: "Network"}
